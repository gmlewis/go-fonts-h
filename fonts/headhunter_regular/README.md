...
import (
  ...
  _ "github.com/gmlewis/go-fonts-h/fonts/headhunter_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from headhunter_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "headhunter_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }

...
import (
  ...
  _ "github.com/gmlewis/go-fonts-h/fonts/helsinkiregular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from helsinkiregular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "helsinkiregular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }

...
import (
  ...
  _ "github.com/gmlewis/go-fonts-h/fonts/heavydata"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from heavydata"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "heavydata", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }

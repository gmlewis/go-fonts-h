...
import (
  ...
  _ "github.com/gmlewis/go-fonts-h/fonts/heydingsicons"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from heydingsicons"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "heydingsicons", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
